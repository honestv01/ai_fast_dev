...
const deliveryPillars = [
  { id: '01', title: 'Product Strategy', copy: 'Clear technical plan before code starts.' },
  { id: '02', title: 'Fast Prototyping', copy: 'Working build in days, not weeks.' },
  { id: '03', title: 'Senior Execution', copy: 'AI speed with human architecture and QA.' },
] as const;

const rotatingHeroLines = [
  'AI-native execution for ambitious founders.',
  'From idea to launch in weeks, not months.',
  'Fast iteration, clear communication, real delivery.',
] as const;
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 w-full pt-28 pb-16 lg:pt-32 lg:pb-20">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-10 items-center">
          <div className={`lg:col-span-7 transition-all duration-1000 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-white/[0.05] border border-white/15 mb-7 backdrop-blur-sm">
              ...
              <span className="text-cyan-200 text-xs sm:text-sm font-medium tracking-wide">Built for speed without sacrificing quality</span>
            </div>
            ...
            <h1 className="text-[2.4rem] sm:text-[3.4rem] lg:text-[4.5rem] xl:text-[5.15rem] font-bold text-white leading-[0.98] tracking-[-0.02em] mb-6">
              Ship intelligent
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-sky-200 via-cyan-300 to-emerald-200">
                digital products fast.
              </span>
            </h1>

            <p className="text-slate-300/95 text-base sm:text-lg lg:text-[1.2rem] leading-relaxed max-w-2xl mb-6">
              I partner with non-technical founders and lean teams to move from rough idea to launch-ready software.
              You stay in control of direction while I handle execution, architecture, and delivery.
            </p>

            <div className="home-hero-typed-wrap mb-10">
              <span className="text-slate-300 font-mono text-sm sm:text-base">
                {typedText}
                <span className="inline-block w-[2px] h-5 align-[-3px] bg-cyan-300 ml-1 animate-pulse" />
              </span>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4 mb-10">
              <button
                ...
                className="shimmer-border inline-flex items-center gap-2 px-7 py-3.5 bg-gradient-to-r from-cyan-300 to-emerald-300 text-[#070707] font-semibold rounded-xl hover:shadow-xl hover:shadow-cyan-400/25 transition-all duration-300 hover:-translate-y-0.5"
              >
                Explore Projects
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-6">
              <div className="flex items-center gap-3">
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-white/5 border border-white/15 flex items-center justify-center text-slate-300 hover:text-white hover:bg-white/10 hover:border-white/30 transition-all duration-300"
                >
                  <Github size={18} />
                </a>
                <a
              ...
              <div className="flex flex-wrap items-center gap-3">
                {stats.slice(0, 3).map((stat) => (
                  <div key={stat.label} className="px-3 py-2 rounded-lg bg-[#0b1523]/70 border border-cyan-200/10">
                    <div className="text-white font-semibold text-sm">{stat.value}</div>
                    <div className="text-[11px] uppercase tracking-[0.12em] text-slate-400">{stat.label}</div>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className={`lg:col-span-5 transition-all duration-1000 delay-300 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="home-hero-panel home-hero-offer energy-card">
              <div className="home-hero-offer-head">
                <span className="home-hero-offer-kicker">How we work</span>
                <span className="home-hero-offer-badge">Limited slots</span>
              </div>

              <h3 className="home-hero-offer-title">
                Premium build quality without
                <span className="block text-cyan-200">agency complexity.</span>
              </h3>
              ...
              <div className="home-hero-offer-chips">
                <span className="home-hero-offer-chip">Next start window: 2-3 days</span>
                <span className="home-hero-offer-chip">Weekly founder sync + async updates</span>
              </div>

              <div className="home-hero-offer-stats">
                <div className="home-hero-metric">
                  <span className="home-hero-metric-value">72h</span>
                  <p className="home-hero-metric-label">First prototype</p>
                </div>
                <div className="home-hero-metric">
                  <span className="home-hero-metric-value">4x</span>
                  <p className="home-hero-metric-label">Faster iteration</p>
                </div>
                <div className="home-hero-metric">
                  <span className="home-hero-metric-value">40+</span>
                  <p className="home-hero-metric-label">Projects delivered</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="absolute bottom-7 left-1/2 -translate-x-1/2">
          <button
            ...
            className="flex flex-col items-center gap-2 text-slate-500 hover:text-cyan-300 transition-colors group"
          >
