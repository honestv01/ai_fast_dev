...
const AppLayout: React.FC = () => {
  ...
  return (
    <div className="theme-shell min-h-screen bg-[#070707] text-white">
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute -top-28 left-[-14rem] w-[34rem] h-[34rem] rounded-full bg-cyan-300/15 blur-[130px] float-slow" />
        <div className="absolute top-[18%] right-[-12rem] w-[30rem] h-[30rem] rounded-full bg-emerald-300/10 blur-[120px] animated-aurora" />
        <div className="absolute bottom-[-12rem] left-1/2 -translate-x-1/2 w-[40rem] h-[28rem] rounded-full bg-sky-300/10 blur-[140px] float-slow" />
        <div className="absolute inset-0 opacity-[0.08] bg-[linear-gradient(rgba(148,163,184,0.22)_1px,transparent_1px),linear-gradient(90deg,rgba(148,163,184,0.22)_1px,transparent_1px)] bg-[size:120px_120px]" />
      </div>
